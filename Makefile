#############################################################################
# Makefile for building: execs/nmea-tests
# Generated by qmake (3.1) (Qt 5.11.1)
# Project:  NMEA-Tests.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile NMEA-Tests.pro
#############################################################################
...
INCPATH       = -I. -Iheaders -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = nmea-tests1.0.0
DISTDIR = /home/n0734498/NMEA-Parser/.tmp/nmea-tests1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		NMEA-Tests.pro headers/earth.h \
		headers/geometry.h \
		headers/logs.h \
		headers/parseNMEA.h \
		headers/position.h \
		headers/types.h src/earth.cpp \
		src/geometry.cpp \
		src/logs.cpp \
		src/position.cpp \
		src/nmea-tests.cpp \
		src/parseNMEA.cpp
QMAKE_TARGET  = nmea-tests
DESTDIR       = execs/
TARGET        = execs/nmea-tests
...
Makefile: NMEA-Tests.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		NMEA-Tests.pro
	$(QMAKE) -o Makefile NMEA-Tests.pro
...
nmea-tests.o: src/nmea-tests.cpp headers/logs.h \
		headers/parseNMEA.h \
		headers/position.h \
		headers/types.h
